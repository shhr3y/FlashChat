...
extension ChatViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.messageText.text = message.body
                                                                                            ...
                                                                                            //This is message for sender user
        if message.sender ==  Auth.auth().currentUser?.email{
            cell.receiverAvtar.isHidden = true
            cell.senderAvtar.isHidden = false
            cell.messageBubble.backgroundColor = UIColor(named: K.BrandColors.lightPurple)
            cell.messageText.textColor = UIColor(named: K.BrandColors.purple)
        }else{                                                                              //This is message for receiver user
            cell.receiverAvtar.isHidden = false
            cell.senderAvtar.isHidden = true
